...
// 3、创建Button组件
const Button = ({ btnType = exports.ButtonType.Primary, size = exports.ButtonSize.Normal, disabled = false, loading = false, icon, children, className, onClick, ...rest }) => {
    ...
    return (jsxRuntime.jsxs("button", { className: buttonClassName, disabled: isDisabled, onClick: onClick, ...buttonProps, children: [loading && (jsxRuntime.jsx("span", { className: "btn-loading-spinner", "aria-hidden": "true" })), icon && !loading && (jsxRuntime.jsx("span", { className: "btn-icon", "aria-hidden": !hasOnlyIcon, children: icon })), children] }));
};
...
const Menu = (props) => {
    ...
    const [activeIndex, setActiveIndex] = React.useState(defaultIndex || 0); //默认高亮项的索引
    const [expandedIndex, setExpandedIndex] = React.useState(undefined); //默认展开项的索引
    ...
    return (jsxRuntime.jsx("ul", { className: menuClassName, style: style, "data-testid": "menu-list", children: jsxRuntime.jsx(MenuContext.Provider, { value: menuContextValue, children: renderChild() }) }));
};
...
const MenuItem = (props) => {
    ...
    return (jsxRuntime.jsx("li", { className: menuItemClassName, style: style, onClick: handleClick, children: children }));
};
...
const SubMenu = (props) => {
    ...
    return (jsxRuntime.jsxs("li", { className: menuItemClassName, style: style, children: [jsxRuntime.jsxs("div", { className: "menu-item-title", onClick: handleTitleClick, children: [title, jsxRuntime.jsx("span", { className: "submenu-arrow", children: mode === 'vertical' ? (jsxRuntime.jsx(Icon, { icon: "caret-right", className: "submenu-arrow-icon" })) : (jsxRuntime.jsx(Icon, { icon: "caret-down", className: "submenu-arrow-icon" })) })] }), jsxRuntime.jsxs("ul", { className: subMenuClassName, children: [renderChildren(), " "] })] }));
};
    ...
    const renderSelectionHeader = () => {
        ...
        return (jsxRuntime.jsx("th", { className: "cream-table-selection-column", style: {
                ...
                padding: '0.75rem',
                    ...
                    minHeight: '40px',
                    minWidth: '40px',
                }, title: allSelected ? '取消全选' : '全选', children: selectionType === 'checkbox' ? (someSelected ? (jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faSquareCheck, style: {
                        color: 'var(--color-primary-500)',
                        fontSize: '20px',
                    } })) : allSelected ? (jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faSquareCheck, style: {
                        color: 'var(--color-primary-500)',
                        fontSize: '20px',
                    } })) : (jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faSquare, style: { color: '#d9d9d9', fontSize: '20px' } }))) : (jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faCircle, style: { color: '#d9d9d9', fontSize: '20px' } })) })) }));
    };
    // 早期返回必须在所有 Hooks 之后
    if (!context) {
        return null;
    ...
    const renderSelectionCell = React.useCallback((record) => {
        ...
        return (jsxRuntime.jsx("td", { className: "cream-table-selection-column", style: {
                ...
                if (!disabled) {
                    ...
                    minHeight: '40px',
                    minWidth: '40px',
                }, children: selectionType === 'checkbox' ? (selected ? (jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faSquareCheck, style: {
                        color: 'var(--color-primary-500)',
                        fontSize: '20px',
                    } })) : (jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faSquare, style: { color: '#d9d9d9', fontSize: '20px' } }))) : selected ? (jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faCircleCheck, style: { color: 'var(--color-primary-500)', fontSize: '20px' } })) : (jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faCircle, style: { color: '#d9d9d9', fontSize: '20px' } })) }) }));
    }, [
...
const Pagination = ({ current: controlledCurrent, total, pageSize: controlledPageSize = 10, onChange, onPageSizeChange, showSizeChanger = false, pageSizeOptions = [10, 20, 50, 100], showTotal = false, showPrevNext = true, className = '', disabled = false, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: `cream-pagination ${disabled ? 'cream-pagination-disabled' : ''} ${className}`.trim(), role: "navigation", "aria-label": "\u5206\u9875\u5BFC\u822A", children: [showTotal && (jsxRuntime.jsxs("div", { className: "cream-pagination-total", children: ["\u5171 ", jsxRuntime.jsx("strong", { children: total }), " \u6761"] })), jsxRuntime.jsxs("div", { className: "cream-pagination-pages", children: [showPrevNext && (jsxRuntime.jsx("button", { className: "cream-pagination-item cream-pagination-prev", disabled: disabled || current === 1, onClick: () => updateCurrent(current - 1), "aria-label": "\u4E0A\u4E00\u9875", children: "\u2190" })), pageNumbers.map((page, index) => {
                        if (page === 'ellipsis') {
                            return (jsxRuntime.jsx("span", { className: "cream-pagination-ellipsis", children: "..." }, `ellipsis-${index}`));
                        }
                        const pageNum = page;
                        const isActive = pageNum === current;
                        return (jsxRuntime.jsx("button", { className: `cream-pagination-item ${isActive ? 'cream-pagination-item-active' : ''}`.trim(), disabled: disabled, onClick: () => updateCurrent(pageNum), "aria-label": `第 ${pageNum} 页`, "aria-current": isActive ? 'page' : undefined, children: pageNum }, pageNum));
                    }), showPrevNext && (jsxRuntime.jsx("button", { className: "cream-pagination-item cream-pagination-next", disabled: disabled || current === totalPages, onClick: () => updateCurrent(current + 1), "aria-label": "\u4E0B\u4E00\u9875", children: "\u2192" }))] }), showSizeChanger && (jsxRuntime.jsx("div", { className: "cream-pagination-options", children: jsxRuntime.jsx("select", { className: "cream-pagination-size-selector", value: pageSize, onChange: e => updatePageSize(Number(e.target.value)), disabled: disabled, "aria-label": "\u6BCF\u9875\u663E\u793A\u6761\u6570", children: pageSizeOptions.map(size => (jsxRuntime.jsxs("option", { value: size, children: [size, " \u6761/\u9875"] }, size))) }) }))] }));
};
...
const TableFoot = () => {
    ...
    return (jsxRuntime.jsx("tfoot", { className: "cream-table-foot", children: jsxRuntime.jsx("tr", { children: jsxRuntime.jsx("td", { colSpan: colSpan, children: jsxRuntime.jsx("div", { className: "cream-table-foot-content", children: jsxRuntime.jsx(Pagination, { total: total, current: finalCurrent, pageSize: finalPageSize, showTotal: showTotal, showSizeChanger: showSizeChanger, onChange: (page, newPageSize) => {
...
const Input = ({ size = 'small', disabled = false, icon, prefix, suffix, className, ...rest }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: inputClassName, children: [prefix && jsxRuntime.jsx("div", { className: "input-prefix", children: prefix }), jsxRuntime.jsx("input", { ...rest, disabled: isDisabled }), icon && jsxRuntime.jsx(reactFontawesome.FontAwesomeIcon, { icon: icon, className: "input-icon" }), suffix && jsxRuntime.jsx("div", { className: "input-suffix", children: suffix })] }));
};
...
const Progress = props => {
    ...
    return (jsxRuntime.jsx("div", { className: "progress-container", style: styles, children: jsxRuntime.jsx("div", { className: "progress-bar", style: { height: `${strokeHeight}px` }, children: jsxRuntime.jsx("div", { className: classNames('progress-fill', {
                    [`progress-fill-${theme}`]: theme,
                    'progress-animated': displayPercent > 0 && displayPercent < 100,
                }), style: { width: `${displayPercent}%` }, children: showText && displayPercent > 0 && (jsxRuntime.jsxs("span", { className: "progress-text", children: [Math.round(displayPercent), "%"] })) }) }) }));
};
...
const FileList = ({ fileList, onRemoved, onToggleStatus, }) => {
    ...
    return (jsxRuntime.jsx("div", { className: "file-list-container", children: jsxRuntime.jsx("div", { className: "file-list", children: fileList.map(item => (jsxRuntime.jsxs("div", { className: `file-item ${getStatusClass(item.status)}`, children: [jsxRuntime.jsxs("div", { className: "file-content", children: [jsxRuntime.jsxs("div", { className: "file-left", children: [jsxRuntime.jsx(Icon, { icon: freeSolidSvgIcons.faFile, className: "file-main-icon" }), jsxRuntime.jsx("div", { className: "file-info", children: jsxRuntime.jsx("span", { className: "file-name", title: item.name, children: item.name }) })] }), jsxRuntime.jsx("div", { className: "file-right", children: jsxRuntime.jsxs("div", { className: "status-section", children: [jsxRuntime.jsx("div", { className: "status-with-remove", children: jsxRuntime.jsx("button", { className: "status-icon-btn", disabled: item.status === 'uploading', onMouseEnter: () => setHoveredItem(item.uid), onMouseLeave: () => setHoveredItem(null), onClick: () => {
                                                ...
                                                }, children: jsxRuntime.jsx(Icon, { icon: getStatusIcon(item.status, hoveredItem === item.uid), className: `status-icon ${getStatusClass(item.status)}` }) }) }), jsxRuntime.jsxs("span", { className: "file-status", children: [item.status === 'uploading' && '上传中...', item.status === 'success' && '上传成功', item.status === 'error' && '上传失败'] })] }) })] }), item.status === 'uploading' && (jsxRuntime.jsx("div", { className: "progress-section", children: jsxRuntime.jsx(Progress, { percent: item.percent, showText: false }) }))] }, item.uid))) }) }));
};
...
const Card = ({ title, extra, cover, actions, bordered = true, hoverable = false, size = 'default', loading = false, className, style, children, }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: cardClassName, style: style, role: "article", children: [cover && (jsxRuntime.jsx("div", { className: "cream-card__cover", "aria-hidden": "true", children: cover })), hasHeader && (jsxRuntime.jsxs("div", { className: "cream-card__header", children: [title && (jsxRuntime.jsx("div", { className: "cream-card__title", children: typeof title === 'string' ? (jsxRuntime.jsx("h4", { className: "cream-card__title-text", children: title })) : (title) })), extra && jsxRuntime.jsx("div", { className: "cream-card__extra", children: extra })] })), jsxRuntime.jsx("div", { className: "cream-card__body", children: loading ? (jsxRuntime.jsxs("div", { className: "cream-card__skeleton", "aria-label": "\u52A0\u8F7D\u4E2D", children: [jsxRuntime.jsx("div", { className: "cream-card__skeleton-row cream-card__skeleton-row--title" }), jsxRuntime.jsx("div", { className: "cream-card__skeleton-row" }), jsxRuntime.jsx("div", { className: "cream-card__skeleton-row" }), jsxRuntime.jsx("div", { className: "cream-card__skeleton-row cream-card__skeleton-row--short" })] })) : (children) }), actions && actions.length > 0 && (jsxRuntime.jsx("div", { className: "cream-card__actions", role: "group", "aria-label": "\u5361\u7247\u64CD\u4F5C", children: actions.map((action, index) => (jsxRuntime.jsx("div", { className: "cream-card__action-item", children: action }, index))) }))] }));
};

// ===== 默认状态图标 =====
const DefaultIcon = ({ status }) => {
    if (status === 'completed') {
        return (jsxRuntime.jsx("svg", { viewBox: "0 0 16 16", width: "10", height: "10", fill: "none", "aria-hidden": "true", children: jsxRuntime.jsx("path", { d: "M2.5 8l4 4 7-7", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round" }) }));
    }
    if (status === 'processing') {
        return (jsxRuntime.jsx("span", { className: "cream-timeline__processing-dot", "aria-hidden": "true" }));
    }
    return null;
};
const TimelineItem = ({ title, content, timestamp, status = 'pending', icon, color, className, isLast, mode, direction, index, }) => {
    ...
    const statusLabel = status === 'completed'
        ...
        : status === 'processing'
            ? '进行中'
            : '待处理';
    return (jsxRuntime.jsxs("li", { className: itemClassName, "aria-label": `时间节点：${statusLabel}`, children: [!isLast && jsxRuntime.jsx("div", { className: "cream-timeline__tail", "aria-hidden": "true" }), jsxRuntime.jsx("div", { className: classNames('cream-timeline__node', {
                    'cream-timeline__node--custom': !!icon,
                }), style: nodeStyle, "aria-hidden": "true", children: icon ? (jsxRuntime.jsx("span", { className: "cream-timeline__node-inner", children: icon })) : (jsxRuntime.jsx("span", { className: "cream-timeline__node-inner", children: jsxRuntime.jsx(DefaultIcon, { status: status }) })) }), jsxRuntime.jsxs("div", { className: "cream-timeline__content", children: [timestamp && (jsxRuntime.jsx("time", { className: "cream-timeline__timestamp", dateTime: timestamp, children: timestamp })), title && (jsxRuntime.jsx("div", { className: "cream-timeline__title", children: typeof title === 'string' ? (jsxRuntime.jsx("span", { className: "cream-timeline__title-text", children: title })) : (title) })), content && jsxRuntime.jsx("div", { className: "cream-timeline__body", children: content })] })] }));
};
// ===== Timeline 主组件 =====
const Timeline = ({ items = [], direction = 'vertical', mode = 'left', className, style, }) => {
    ...
    return (jsxRuntime.jsx("ol", { className: rootClassName, style: style, "aria-label": "\u65F6\u95F4\u8F74", children: items.map((item, index) => (jsxRuntime.jsx(TimelineItem, { ...item, isLast: index === items.length - 1, mode: mode, direction: direction, index: index }, index))) }));
};
...
const Tag = ({ children, color = TagColor.Default, size = TagSize.Medium, clickable = false, closable = false, onClick, onClose, className, }) => {
    ...
    return (jsxRuntime.jsxs("span", { className: `cream-tag cream-tag--${color} cream-tag--${size} ${clickable ? 'cream-tag--clickable' : ''} ${className || ''}`, onClick: handleClick, children: [jsxRuntime.jsx("span", { className: "cream-tag__text", children: children }), closable && (jsxRuntime.jsx("span", { className: "cream-tag__close", onClick: handleClose, role: "button", tabIndex: 0, "aria-label": "\u5173\u95ED", children: "\u00D7" }))] }));
};

exports.Button = Button;
exports.Card = Card;
exports.Form = TransForm;
exports.Icon = Icon;
exports.Input = Input;
exports.Menu = TransMenu;
exports.Pagination = Pagination;
exports.Progress = Progress;
exports.Table = TableContainer;
exports.Tag = Tag;
